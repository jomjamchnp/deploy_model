...
def check_quardrant(name,total,xmin,xmax,ymin,ymax,x,y):
...
def score_num(NAME,image_number):
    global c_errorQ1,c_errorQ2,c_errorQ3,c_errorQ4 
    global listofp,line,list,list_digit,list_centroid,list_ofq,sort_list_centroid,boxofnum,arraylist,list_boolean
    ...
    for i in range(0, len(data_corr)):
        ...
        check_quardrant(name[0],total,xmin,xmax,ymin,ymax,x,y)
